...
import smbForgetPasswordV3 from '../../pageComponent/smbForgetAndResetPasswordV3/smbForgetPasswordV3';

export default {
  title: 'smbForgetPasswordV3',
  component: smbForgetPasswordV3,
};

export const smbForgetAndResetPasswordV3 = () => ({
  components: { smbForgetPasswordV3 },
  template: `<smb-forget-password-v3 :smbForgetPasswordV3Data="smbForgetAndResetPasswordV3"></smb-forget-password-v3>`,
  data() {
    return {
