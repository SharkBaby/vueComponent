...
import smbLoginEmailAddressForm from '../../pageComponent/smbLoginV3/smbLoginEmailAddressForm';

export default {
  title: 'smbLoginEmailAddressForm',
  component: smbLoginEmailAddressForm,
};
...
export const smbLoginV3 = () => ({
  ...
  template: `<smb-login-email-address-form :statusInfo="statusInfo" :i18n="i18n" :userInfo="userInfo" :step1PopoverShow="step1PopoverShow" :rememberMeToggle="rememberMeToggle" @asyncComponentData="asyncComponentData" ></smb-login-email-address-form>`,
  data() {
    return {
